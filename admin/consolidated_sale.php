...
<form id="frmpartyList" name="frmpartyList" method="post" action="">
  ...
  <tr>
	<td  width="50%" valign="top">
			...
			<td width="14%" align="center" class="text07">Invoice No</td>
            ...
            <td width="16%" align="center" class="text07">Remarks</td>
			...
			<tr><td width="5%" align="left" valign="top">  <?=$s_cr_list['sod']?> </td>
				...
				<td width="14%" align="right" valign="top"><?=$s_cr_list['bill_no']?>  </td>
                ...
                <td width="16%" align="left" valign="top"><?=$s_cr_list['remarks']?>  </td>
 			</tr>
			<?php
 			}
			 ?>
