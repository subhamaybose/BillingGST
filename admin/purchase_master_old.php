<?php
	...
	if(isset($_POST['bill_no']))
	{
		...
		if(mysql_num_rows($tok_chk_old) == 0)
		{
			...
			//The main SQL
			$sql_main = "insert into sales_order set invoice_no = '" . trim($_POST['invoice_no']) . "', invoice_date = '" . date('Y-m-d', strtotime($_POST['invoice_date'])) . "', purchase_order_id = '" . trim($_POST['purchase_order_id']) . "', purchase_order_date = '" . date('Y-m-d', strtotime($_POST['purchase_order_date'])) . "', doc_no = '" . trim($_POST['doc_no']) . "', doc_date = '" . date('Y-m-d', strtotime($_POST['doc_date'])) . "', purchase_order_amount = '" . $_POST['purchase_order_amount'] . "', party_id = '" . $_POST['party_id'] . "', vat = '" . $_POST['vat'] . "', freight = '" . $_POST['freight'] . "', discount = '" . $_POST['discount'] . "', cst = '" . $_POST['cst'] . "', adjustment_amount = '" . $_POST['adjustment_amount'] . "', narration = '" . $_POST['narration'] . "'";
			//echo $sql_main . '<br />';
				  ...
				  <input name="item_id" type="hidden" value="<?php echo $_REQUEST["item_id"] ?>" />
                   ...
                   <table width="100%" border="0" cellspacing="0" cellpadding="5">
					...
					<tr>
                      ...
                      <td height="20"><input name="invoice_no" class="input" id="invoice_no" value="<?php echo $r_edit["invoice_no"] ?>" tabindex="3" size="20" /></td>
                    </tr>
					<tr>
                      <td>Invoice Date (*):</td>
                      <td valign="middle"><input name="invoice_date" class="input" id="invoice_date" tabindex="2" value="<?php echo $r_edit["invoice_date"]?>" size="20" readonly />&nbsp;
					  ...
					  <A HREF="#" onClick="cal1x.select(document.forms[0].invoice_date,'anchor1x','MM/dd/yyyy'); return false;" TITLE="cal1x.select(document.forms[0].invoice_date,'anchor1x','MM/dd/yyyy'); return false;" NAME="anchor1x" ID="anchor1x"><img src="images/show-calendar.gif" border="0" align="absmiddle" /></A></td>
                    </tr>
					
					<tr>
                      <td>
                        <label>Order No.  : </label></td>
                      <td><input name="purchase_order_id" class="input" id="purchase_order_id" value="<?php echo genBillNo(); ?>" tabindex="1" size="20" /></td>
                    </tr>
					<tr>
                      <td>Order Date (*):</td>
                      <td valign="middle"><input name="purchase_order_date" class="input" id="purchase_order_date" tabindex="2" value="<?php echo $r_edit["purchase_order_date"]?>" size="20" readonly />&nbsp;
					  <SCRIPT LANGUAGE="JavaScript" ID="jscal1x">
						var cal1x = new CalendarPopup("testdiv1");
						</SCRIPT>
						<!-- The next line prints out the source in this example page. It should not be included when you actually use the calendar popup code -->
						<SCRIPT LANGUAGE="JavaScript">writeSource("jscal1x");</SCRIPT>
					  <A HREF="#" onClick="cal1x.select(document.forms[0].purchase_order_date,'anchor1x','MM/dd/yyyy'); return false;" TITLE="cal1x.select(document.forms[0].purchase_order_date,'anchor1x','MM/dd/yyyy'); return false;" NAME="anchor1x" ID="anchor1x"><img src="images/show-calendar.gif" border="0" align="absmiddle" /></A></td>
                    </tr>
					
 					<tr>
                      <td>
                        <label>DOC No.  (*): </label></td>
                      <td height="20"><input name="doc_no" class="input" id="doc_no" value="<?php echo $r_edit["doc_no"] ?>" tabindex="5" size="20" /></td>
                    </tr>
					<tr>
                      <td>DOC Date (*):</td>
                      <td height="20"><input name="doc_date" class="input" id="doc_date" tabindex="6" value="<?php echo $r_edit["doc_date"]?>" size="20"  readonly />
					  &nbsp;
					  <SCRIPT LANGUAGE="JavaScript" ID="jscal1x">
						var cal1x = new CalendarPopup("testdiv1");
						</SCRIPT>
					...
					<tr>
                      <td>Total Amount. :</td>
                      <td height="20">
					  	<input name="purchase_order_amount" class="input" id="purchase_order_amount" tabindex="10" value="<?php echo $r_edit["purchase_order_amount"]?>" readonly onkeypress="return isNumberKey(event)" size="20" />
					  </td>
                    </tr>
					...
					<tr>
 					...
 					<tr>
                      ...
                      <td height="20">
					  	<input name="adjustment_amount" class="input" id="adjustment_amount" tabindex="15" value="0" onkeypress="return isNumberKey(event)" size="20" onchange="calculateSaleTotals();" />
					  </td>
                    </tr>
 					<tr>
                      <td>Remarks. :</td>
