	...
	<td colspan="1" width="50%" valign="top">
			...
			<?php
			 ...
			 <!--<td>&nbsp;</td>-->
              ...
              <tr>
                        <td colspan="4" align="right"><input type="button" value="Print" onclick="JavaScript:window.open('./party_wise_purchase_print.php?party_type=1&<?php echo $qstring?>');" /> </td>
