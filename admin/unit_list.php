...
function delChk(unit_id){
if(confirm("Do you want to delete the unit ? ")){
 window.location.href="./unit_list.php?unit_id="+unit_id+"&mode=del";
}
              ...
              <table width="98%" border="0" cellpadding="0" cellspacing="1" bgcolor="#999999">
                <tr>
                  <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td height="30" colspan="1" background="images/login_bg.gif"><img src="images/login_bg.gif" width="15" height="30" align="absmiddle" /><strong>Unit List</strong></td>
						<td align="right"  background="images/login_bg.gif"><input name="adbutton" type="button" class="btn" value="Add" onclick="JavaScript:window.location.href='unit_master.php?mode=add'" /></td>
                      </tr>
                      <tr>
                        <td width="80%" height="30" align="left" bgcolor="#e6e6e6"><strong>Unit Name</strong></td>
 						<td width="20%" align="center" bgcolor="#e6e6e6"><strong>Action</strong></td>
                      </tr>
					   <?php
					   
					   $sql_usr="select count(*) from unit_master order by unit_name ";
						// $qstring="unit_id=".$_REQUEST["unit_id"]."&intSemester=".$_REQUEST["intSemester"];
					  ...
					  $sql_usr="select *  from unit_master order by unit_name ";
					  ...
					  ?>
                      <tr>
                        <td height="30" align="left" width="80%" ><?php echo $row_usr['unit_name']; ?></td>
                         <td align="center" nowrap="nowrap"> 
                           <input name="edbutton" type="button" class="btn" value="Edit" onclick="JavaScript:window.location.href='./unit_master.php?unit_id=<?php echo $row_usr['unit_id']; ?>&mode=edit'" /> &nbsp;&nbsp;&nbsp; 
 						 <input name="delbutton" type="button" class="btn" value="Delete" onclick="JavaScript:delChk('<?php echo $row_usr['unit_id']; ?>')" />
                          </td>
                      </tr>
                      <?php
					   }
                    ...
                    <tr>
                      <?php
							if ($pageNumber > 1)  {
								?>
                      <td width="101" height="25" align="right" class="style1"><a href="unit_list.php?page=1&max=1&<?=$qstring?>" class="lnk">&lt;&lt;</a></td>
                      <td width="66" align="right"><a href="unit_list.php?page=<?php print($pageNumber - 1); ?>&max=1&<?=$qstring?>" class="lnk">&lt;</a></td>
                      <?php
							}
							else {
								?>
                      ...
                      <?php
							if ($pageNumber < $pages) {
								?>
                      <td width="80" height="25" align="left"><a href="unit_list.php?page=<?php print($pageNumber + 1); ?>&max=1&<?=$qstring?>" class="lnk">&gt;</a></td>
                      <td width="46" align="left"><a href="unit_list.php?page=<?php print($pages); ?>&max=1&<?=$qstring?>" class="lnk">&gt;&gt;</a></td>
                      <?php
							}
							else {
								?>
