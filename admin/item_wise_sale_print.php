...
?>
             ...
             <tr>
 						<td align="center" colspan="7">
							<span style="font-size:20px; font-weight:bold;">Item wise Sale Report  of <?=$item_name?>  from <?=$start_date?> to <?=$end_date?></span>
						</td>
			  </tr>
			<tr >
			<td width="5%" align="left" class="text07">&nbsp;<strong>Date</strong></td>
			<td width="15%" align="left" class="text07"><strong>Bill No </strong></td>
			<td width="35%" align="" class="text07"><strong>Item Details</strong></td>
			<td width="10%" align="right" class="text07"><strong>Bill Amount</strong></td>
			<td width="5%" align="right" class="text07"><strong>Qty</strong></td>
			<td width="5%" align="right" class="text07"><strong>Rate</strong></td>
			<td width="5%" align="right" class="text07"><strong>Item Amount</strong></td>
			</tr>
