...
<body >
			...
			<?php bill_header($data_sale,1); ?>
					...
					$set_newPage=0;
					$page_count=1;
					if($tot_row>9) $rw_height="52"; else $rw_height="40";
...
{
$strout='<table border="1px solid black" width="100%">

		 <tr>
			<td>
				<table width="100%">
			<tr>
			<td width="50%" align="right">Page :'.$pg.'</td>
			<td width="50%" align="right">Original/Duplicate/Triplicate</td>
			</tr>
			</table>
		</td>
			</tr>	
			...
			<td>
				<table border="1px solid black" width="100%">
					<tr height="20px;">
						...
						<td width="10%">'.$data_sale['packing_qty'] .'</td>
					</tr>
				</table>
			</td>
		</tr>
