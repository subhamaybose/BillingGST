...
<form id="frmpartyList" name="frmpartyList" method="post" action="">
  ...
  <tr><td colspan="3" class="text07" align="left">&nbsp;Credit </td>
  <td colspan="3" class="text07" align="left"> Debit </td></tr>
 ...
 <tr>
	<td colspan="3" width="50%" valign="top">
			...
			<tr>
				<td width="21%" align="left" class="text07">&nbsp;</td>
				<td width="59%" align="right" class="text07">Total&nbsp;</td>
				<td width="20%" align="right" class="text07"><?=$total_cr?>&nbsp;&nbsp;&nbsp;</td>
			</tr>
			
 			<tr>
				<td width="21%" align="left" class="text07">&nbsp;</td>
				<td width="59%" align="right" class="text07">Closing Balance&nbsp;</td>
				<td width="20%" align="right" class="text07"><?=$total_dr-$total_cr?>&nbsp;&nbsp;&nbsp;</td>
			</tr>
  			</table>
	...
	<td colspan="3" valign="top">
		...
		<tr>
			<td width="21%" align="left" class="text07">&nbsp;</td>
			<td width="59%" align="right" class="text07">Total&nbsp;</td>
			<td width="20%" align="right" class="text07"><?=$total_dr?>&nbsp;&nbsp;&nbsp;</td>
		</tr>
	...
	<!--<tr><td align="right" colspan="3" class="text07">Total <?=$total_cr?>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	<td align="right" colspan="3" class="text07">Total <?=$total_dr?>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
	<tr><td colspan="3">Closing Balance = <?=$total_dr-$total_cr?></td></tr>-->
