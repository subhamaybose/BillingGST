...
<body >
	...
	<tr><td width="800" height="1080" bgcolor="#99CC99">H</td></tr>
			...
			<?php bill_header($data_sale,1); ?>
					...
					//echo $rw;
					if($rw>6) {
					for($vac_row =$rw ; $vac_row <10; $vac_row++)
					{
						?>
						<tr height="35">
							<td>&nbsp;</td>
					...
					$page_count++;
						...
						bill_header($data_sale,$page_count);
						sub_head();
						for($vac_row =1 ; $vac_row <10; $vac_row++)
					{
						?>
						<tr height="35">
							<td>&nbsp;</td>
					...
					for($vac_row =$rw ; $vac_row <= 7; $vac_row++)
					{
						?>
						<tr height="30">
							<td>&nbsp;</td>
...
$strout= '
		 ...
		 <input type="button" value="Print" id="Print" onClick="javascript:saveExtra();this.style.display=\'none\';document.getElementById(\'bck\').style.display=\'none\';window.print();">&nbsp;<input id="bck" type="button" value="Back to Sales" onClick="javascript:window.location.href=\'./sales_list_vat.php\'"> 
		 </div>';
		 }
						$strout.= '</td>
					</tr>
