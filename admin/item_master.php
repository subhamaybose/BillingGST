...
if(isset($_POST['bsave'])){
	if( $item_id==""){	
		if(chkDuplicateUser(strtoupper($_POST['item_code']))){
			...
			$sql_insert="INSERT INTO item_master (item_code,item_name,item_hsn,item_description,item_stock,unit_id,category_id,capacity_id,item_type,item_purchase_rate,item_sale_rate)";
			
			$sql_insert.="VALUES('".trim(strtoupper($_POST['item_code']))."', '".trim(addslashes(ucwords($_POST['item_name'])))."','".trim(addslashes($_POST['item_hsn']))."',
			...
			if(chkDuplicateUser($_POST['item_code'],$_POST['item_id'])){
				...
				$sql_edit.="item_name='".trim(addslashes(ucwords($_POST['item_name'])))."',item_hsn='".trim(addslashes($_POST['item_hsn']))."',item_description='".trim(addslashes(ucwords($_POST['item_description'])))."',item_stock='".trim(strtoupper($_POST['item_stock']))."',";
                ...
                <tr>
				  ...
				  <input name="item_id" type="hidden" value="<?php echo $_REQUEST["item_id"] ?>" />
                   ...
                   <table width="100%" border="0" cellspacing="0" cellpadding="5">
					...
					<tr>
                      <td>HSN Code (*):</td>
                      <td height="20"><input name="item_hsn" class="input" id="item_hsn" tabindex="3" value="<?php echo $r_edit["item_hsn"]?>" size="20" /></td>
                    </tr>
					<tr>
                      <td>Description :</td>
                      <td height="20"><textarea name="item_description" tabindex="3" cols="20" rows="4" style="width:250px;"><?=$r_edit["item_description"]?></textarea></td>
                    </tr>
                    <tr>
                      <td>Quantity (*):</td>
                      <td height="20"><input name="item_stock" class="input" id="item_stock" tabindex="5" value="<?php echo $r_edit["item_stock"]?>" size="20" /></td>
                    </tr> 
					 <tr>
                      <td>Unit:</td>
                      <td height="20">
					  <select name="unit_id" tabindex="6">
					...
					<tr>
                      <td>Capacity:</td>
                      <td height="20">
					  <select name="capacity_id" tabindex="7">
					  <option value="">< -- Select -- ></option>
					  <?php
                      ...
                      <td>Porosity:</td>
                      <td height="20">
					  <select name="category_id" tabindex="8">
 					  <option value="">< -- Select -- ></option>
					  <?php
 					...
 					<tr>
                      <td>Type :</td>
                      <td height="20">
					  <select name="item_type" id="item_type" tabindex="9" onchange="setItemCodePrefix(this.value);">
                    ...
                    <tr>
                      <td>Purchase Rate:</td>
                      <td height="20"><input name="item_purchase_rate" class="input" id="item_purchase_rate" tabindex="10" value="<?php echo $r_edit["item_purchase_rate"] ?>" size="20" /></td>
                    </tr>
					<tr>
                      <td>Sale Rate:</td>
                      <td height="20"><input name="item_sale_rate" class="input" id="item_sale_rate" tabindex="11" value="<?php echo $r_edit["item_sale_rate"] ?>" size="20" /></td>
                    </tr>
					<?php /*?><tr>
                      <td>Capacity:</td>
